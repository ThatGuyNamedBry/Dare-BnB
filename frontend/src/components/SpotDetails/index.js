...
//   const shouldShowReviewButton = () => {
//     if (!currentUser || currentUser.id === spot.Owner?.id) {
//       // Hide the button if the user is not logged in or if they are the owner of the spot
//       return false;
//     }
//     // Check if the user has already posted a review for this spot
//     const userReview = Object.values(allReviews).find(review => review.userId === currentUser.id);
//     return !userReview;
//   };

//   const renderReviewButtonAndText = () => {
//     if (!shouldShowReviewButton()) {
//       return null; // Hide the button and text if the conditions are not met
//     }
//     return (
//       <>
//         <button onClick={openReviewModal}>Post Your Review</button>
